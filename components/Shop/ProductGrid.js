...
const products = [
  { 
    name: "Organic Green Tea", price: "€10", type: "tea", amount: "100g",
  ...
  { 
    name: "Cold Brew Beans", price: "€9", type: "coffee", amount: "250g",
  ...
  { 
    name: "Herbal Chamomile", price: "€12", type: "tea", amount: "50g",
  ...
  { 
    name: "Espresso Beans", price: "€8", type: "coffee", amount: "250g",
  ...
  { 
    name: "Matcha Powder", price: "€11", type: "tea", amount: "100g",
  ...
  { 
    name: "Fresh Lemonade Powder", price: "€7", type: "other", amount: "200g",
...
<div style="font-size: 40px; margin-bottom: 10px;">
    ...
    <p style="font-weight: bold; margin: 0;">{{ p.price }} / {{p.amount}}</p>
